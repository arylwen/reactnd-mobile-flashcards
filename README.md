...
On some Samsung devices (e.g. Note3) the KeyboardAvoidingView does not lift the content high enough to reveal all the controls. Samsung Keyboard has an extra line on top showing the predictions based on the character entered.
